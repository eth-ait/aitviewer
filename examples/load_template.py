...
if __name__ == '__main__':
    ...
    mano_template = SMPLSequence.t_pose(SMPLLayer(model_type='mano', gender='neutral', device=C.device),
                                        position=np.array((-1.0, 0.0, 0.0)), name='MANO')
    flame_template = SMPLSequence.t_pose(SMPLLayer(model_type='flame', gender='neutral', device=C.device),
                                         position=np.array((1.0, 0.0, 0.0)), name='FLAME')
